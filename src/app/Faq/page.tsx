        ...
        <S.Container>
          <S.FaqContainer>
            ...
            <S.FaqItem className="mg-bottom">
              ...
              />
              <p>
                Eu tendo ligar o meu carro e ele nao aparece nada no painel nem
                da sinal de vida Mostrar rascunhos
              </p>
            </S.FaqItem>
            <S.FaqItem>
              <Image
                ...
                <ul>
                  <li className="itemDestaque">
                    <p>
                      ...
                      carro por perto, pode tentar ligar o seu usando a bateria
                      do outro veículo. Mas atenção: Certifique-se de fazer isso
                      com a ajuda de um adulto e seguindo as instruções corretas
                      para evitar danos ao seu carro ou ao outro veículo.
                    </p>
                  </li>
                </ul>
              </div>
